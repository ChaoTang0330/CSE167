...
GLuint Geometry::program, Geometry::modelLoc, Geometry::colorLoc;
GLuint Sphere::sphereFlag(1), Sphere::program, Sphere::colorLoc, Sphere::modelLoc;

//glm::mat4 Geometry::projection;
//GLuint Geometry::projectionLoc, Geometry::viewLoc;

//glm::vec3 Geometry::eye(0, 0, 35); // Camera position.
//glm::vec3 Geometry::center(0, 0, 0); // The point we are looking at.
//glm::vec3 Geometry::up(0, 1, 0); // The up direction of the camera.

// View matrix, defined by eye, center and up.
//glm::mat4 Geometry::view = glm::lookAt(Geometry::eye, Geometry::center, Geometry::up);
Geometry::Geometry() {}
...
void Geometry::draw(glm::mat4 curModel, GLint color)
{
	setModelMatrix(curModel);
...
void Geometry::setModelMatrix(glm::mat4 curModel)
{
	model = curModel;
...
void Geometry::setShaderProID(GLuint programID) 
{ 
	program = programID; 
...
Sphere::Sphere(std::string objFilename) 
{ 
	model = glm::mat4(1);
...
void Sphere::draw(glm::mat4 curModel, GLint color)
{
	if (sphereFlag == 0)
	{
		return;
...
void Sphere::setColor(GLint color)
{
...
void Sphere::setProgramID(GLuint ID)
{
	program = ID;
