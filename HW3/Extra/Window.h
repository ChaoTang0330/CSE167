...
public:
	...
	static void Window::rotateCamera(glm::vec3 prevCursorPos, glm::vec3 curCursorPos);

	static int cullingEnable;
	static int cullingRefreshFlag;
